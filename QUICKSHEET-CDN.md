# FireSchema — Quicksheet: CDN (Option A)

Zero install, zero dependencies. Just an HTML file + your schemas.
...
└── docs/database/firebase/
    ├── index.html                    <-- viewer (loads from CDN)
...
- **Install**: nothing (CDN)
- **Dependencies**: 0
- **Files in git**: `index.html` + `schemas/*.schema.json`
- **Requires internet**: yes (CDN + Google Fonts)
- **vs npm dist**: lighter git footprint, but needs internet to load viewer
